...
//
// autoconfig_zii_b64.v — Zorro II autoconfig shell for Base64 (fx68k compat build)
//
...
module autoconfig_zii_b64 #(
    ...
    input  wire [23:16] a_high,     // core A[23:16]
...
assign ac_access = !cfgin_n && cfgout_n && (a_high == 8'hE8) && !as_n;
